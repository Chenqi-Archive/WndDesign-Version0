...
void WndDesign::Blinking::Init() { state = false; }

void WndDesign::Blinking::Next() { state = !state; }
...
void WndDesign::SimpleClock::Init() { angle = 270; }

void WndDesign::SimpleClock::Next() { angle += 6; angle %= 360; }
