...
#include "./shape/Animation.h"

inline WndID CreateWnd(WndID parent, Pos pos, Size size, Figure& figure, WndMsgHandler handler)
{
	WndInfo wnd = { parent, pos, size, figure, handler };
